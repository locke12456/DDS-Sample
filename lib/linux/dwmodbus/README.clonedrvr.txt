...
into a new driver.
It is a part of the DeviceWISE Software Development Kit (dwsdk).  
It will allow one to create a "clone" of the dwmodbus deviceWISE driver - located 
...
Note that dwsdk_directory is the directory containing the deviceWISE SDK; and
...
This file must be copied to the directory where deviceWISE is installed. 
