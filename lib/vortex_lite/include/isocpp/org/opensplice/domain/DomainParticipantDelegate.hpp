...
#ifndef LITE_DOMAIN_PARTICIPANT_DELEGATE_HPP_
#define LITE_DOMAIN_PARTICIPANT_DELEGATE_HPP_
...
public:
    ...
    dds_entity_t registerType(const std::string typeName,
                               const std::string typeDescriptor,
                               org::opensplice::topic::DataRepresentationId_t dataRepresentationId,
                               const std::vector<uint8_t> typeHash,
                               const std::vector<uint8_t> metaData,
                               const std::vector<uint8_t> extentions) const;
...
private:
    ...
    dds_participantlistener_t listener_callback_pointers ;
};

#endif /* LITE_DOMAIN_PARTICIPANT_DELEGATE_HPP_ */
