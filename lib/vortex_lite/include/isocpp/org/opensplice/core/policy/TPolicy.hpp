...
#ifndef LITE_CORE_POLICY_TPOLICY_HPP_
#define LITE_CORE_POLICY_TPOLICY_HPP_
...
public:
     ...
     */
    TScheduling& scheduling_kind(const org::opensplice::core::policy::SchedulingPriorityKind::Type& scheduling_priority_kind)
    {
...
#endif /* LITE_CORE_POLICY_TPOLICY_HPP_ */
