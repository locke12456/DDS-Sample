...
#ifndef LITE_CORE_STATUS_STATUS_DELEGATE_HPP_
#define LITE_CORE_STATUS_STATUS_DELEGATE_HPP_
...
public:
    void v_status(const dds_inconsistent_topic_status_t* from)
    {
        total_count_ = from->total_count;
...
public:
    void v_status(const dds_sample_lost_status_t* from)
    {
        total_count_ = from->total_count;
        total_count_change_ = from->total_count_change;
    }
...
public:
    void v_status(const dds_sample_rejected_status_t* from)
    {
        total_count_ = from->total_count;
        total_count_change_ = from->total_count_change;
...
public:
    void v_status(const dds_liveliness_lost_status_t* from)
    {
        total_count_ = from->total_count;
        total_count_change_ = from->total_count_change;
    }
...
public:
    void v_status(const dds_liveliness_changed_status_t* from)
    {
        alive_count_ = from->alive_count;
        not_alive_count_ = from->not_alive_count;
...
public:
    void v_status(const dds_offered_deadline_missed_status* from)
    {
        total_count_ = from->total_count;
        total_count_change_ = from->total_count_change;
        last_instance_handle_ = dds::core::InstanceHandle(from->last_instance_handle);
...
public:
    void v_status(const dds_requested_deadline_missed_status_t* from)
    {
        total_count_ = from->total_count;
        total_count_change_ = from->total_count_change;
        last_instance_handle_ = dds::core::InstanceHandle(from->last_instance_handle);
...
public:
    void v_status(const dds_offered_incompatible_qos_status_t* from)
    {
        total_count_ = from->total_count;
        total_count_change_ = from->total_count_change;
...
public:
    void v_status(const dds_requested_incompatible_qos_status_t* from)
    {
        total_count_ = from->total_count;
        total_count_change_ = from->total_count_change;
        last_policy_id_ = from->last_policy_id;
...
public:
    void v_status(const dds_publication_matched_status_t* from)
    {
        total_count_ = from->total_count;
        total_count_change_ = from->total_count_change;
        current_count_ = from->current_count;
...
public:
    void v_status(const dds_subscription_matched_status_t* from)
    {
        total_count_ = from->total_count;
        total_count_change_ = from->total_count_change;
        current_count_ = from->current_count;
...
#endif /* LITE_CORE_STATUS_STATUS_DELEGATE_HPP_ */
