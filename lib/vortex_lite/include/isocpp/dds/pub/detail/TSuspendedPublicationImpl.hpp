 ...
 *
 */
#ifndef LITE_DDS_PUB_TSUSPENDEDPUBLICATION_IMPL_HPP_
#define LITE_DDS_PUB_TSUSPENDEDPUBLICATION_IMPL_HPP_
...
#endif /* LITE_DDS_PUB_TSUSPENDEDPUBLICATION_IMPL_HPP_ */
