 ...
 *
 */
#ifndef LITE_DDS_CORE_POLICY_TQOSPOLICYCOUNT_IMPL_HPP_
#define LITE_DDS_CORE_POLICY_TQOSPOLICYCOUNT_IMPL_HPP_
...
#endif /* LITE_DDS_CORE_POLICY_TQOSPOLICYCOUNT_IMPL_HPP_ */
