 ...
 *
 */
#ifndef LITE_DDS_CORE_COND_TSTATUSCONDITION_IMPL_HPP_
#define LITE_DDS_CORE_COND_TSTATUSCONDITION_IMPL_HPP_
...
#endif /* LITE_DDS_CORE_COND_TSTATUSCONDITION_IMPL_HPP_ */
