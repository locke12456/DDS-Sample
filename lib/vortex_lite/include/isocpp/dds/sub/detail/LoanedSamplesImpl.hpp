 ...
 *
 */
#ifndef LITE_DDS_SUB_DETAIL_LOANED_SAMPLES_IMPL_HPP_
#define LITE_DDS_SUB_DETAIL_LOANED_SAMPLES_IMPL_HPP_
...
#endif /* LITE_DDS_SUB_DETAIL_LOANED_SAMPLES_IMPL_HPP_ */
