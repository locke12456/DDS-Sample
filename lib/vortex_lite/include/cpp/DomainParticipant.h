...
namespace DDS
{
    namespace OpenSplice
    {
              ...
              public ::DDS::OpenSplice::Entity
        {
            ...
            friend class ::DDS::DomainParticipantListener;
        ...
        private:
            ...
            static DDS::Boolean
            rlReq_fnFindTopic(DDS::Object_ptr td, findObjectArg *arg);

            static DDS::Boolean
            rlReq_fnFindMetaHolderByIDLTypeName(const char *key, DDS::Object_ptr mh, struct findObjectArg *arg);

            DDS::OpenSplice::TopicDescription *
            rlReq_findTopicDescription(const char *topicName);
            dds_entity_t
            rlReq_findTopic(const char *topicName);
            ...
            rlReq_findMetaHolderByIDLTypeName(const char *typeName);
