...
private:
    ...
    void* timed_flush()
    {
                ...
                !(qos_.template policy<dds::streams::core::policy::StreamFlush>().max_delay() == dds::core::Duration::infinite()))
        {
            ...
            delay.tv_sec = (os_timeSec)qos_.template policy<dds::streams::core::policy::StreamFlush>().max_delay().sec();
            delay.tv_nsec = (os_int32)qos_.template policy<dds::streams::core::policy::StreamFlush>().max_delay().nanosec();
