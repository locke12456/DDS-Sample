...
struct v_durabilityServicePolicyI_s {
    struct v_durabilityServicePolicy v;
};
...
C_STRUCT(v_transactionGroup) {
    ...
    c_bool aborted;
    c_list transactions;
    c_array undiscoveredList /*C_ARRAY<kernelModule::v_gid>*/;
    c_set writers;
};
...
C_STRUCT(v_subscriber) {
    ...
    c_set readers;
    c_set shares;
    v_transactionGroupAdmin transactionAdmin;
};
