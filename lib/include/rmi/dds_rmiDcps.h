...
namespace DDS_RMI
{
   ...
   class DDS_SERVICE_API IdentificationTypeSupportInterface;
   ...
   class DDS_SERVICE_API IdentificationDataWriter;
   ...
   class DDS_SERVICE_API IdentificationDataReader;
   ...
   class DDS_SERVICE_API IdentificationDataReaderView;
   ...
   class DDS_SERVICE_API DefinitionTypeSupportInterface;
   ...
   class DDS_SERVICE_API DefinitionDataWriter;
   ...
   class DDS_SERVICE_API DefinitionDataReader;
   ...
   class DDS_SERVICE_API DefinitionDataReaderView;
