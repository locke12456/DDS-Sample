...
namespace SEMADDS_Types {
    ...
    class OS_SEMADDS_API SemaEApiTypeSupportMetaHolder : public ::DDS::OpenSplice::TypeSupportMetaHolder
    {
    public:
        SemaEApiTypeSupportMetaHolder ();
        virtual ~SemaEApiTypeSupportMetaHolder ();
    ...
    class OS_SEMADDS_API SemaEApiTypeSupport : public virtual SemaEApiTypeSupportInterface,
                                                       public ::DDS::OpenSplice::TypeSupport
    {
    public:
        SemaEApiTypeSupport ();
    
        virtual ~SemaEApiTypeSupport ();
    
    private:
        SemaEApiTypeSupport (const SemaEApiTypeSupport &);
    
        void operator= (const SemaEApiTypeSupport &);
    };
    
    typedef SemaEApiTypeSupportInterface_var SemaEApiTypeSupport_var;
    typedef SemaEApiTypeSupportInterface_ptr SemaEApiTypeSupport_ptr;
    
    class OS_SEMADDS_API SemaEApiDataWriter_impl : public virtual SemaEApiDataWriter,
                                                           public ::DDS::OpenSplice::FooDataWriter_impl
    {
        friend class DDS::OpenSplice::Publisher;
        friend class SemaEApiTypeSupportMetaHolder;
    
    public:
        virtual ::DDS::InstanceHandle_t register_instance (
            const SemaEApi & instance_data) THROW_ORB_EXCEPTIONS;
    ...
    protected:
        SemaEApiDataWriter_impl ();
    
        virtual ~SemaEApiDataWriter_impl ();
    ...
    private:
        SemaEApiDataWriter_impl (const SemaEApiDataWriter_impl &);
    
        void operator= (const SemaEApiDataWriter &);
    };
    
    class OS_SEMADDS_API SemaEApiDataReader_impl : public virtual SemaEApiDataReader,
                                                           public ::DDS::OpenSplice::FooDataReader_impl
    {
        friend class DDS::OpenSplice::Subscriber;
        friend class SemaEApiTypeSupportMetaHolder;
        friend class SemaEApiDataReaderView_impl;
    
    public:
        virtual ::DDS::ReturnCode_t read (
            SemaEApiSeq & received_data,
            ::DDS::SampleInfoSeq & info_seq,
            ::DDS::Long max_samples,
            ::DDS::SampleStateMask sample_states,
            ::DDS::ViewStateMask view_states,
        ...
        virtual ::DDS::InstanceHandle_t lookup_instance (
            const SemaEApi & instance) THROW_ORB_EXCEPTIONS;
    
    protected:
        SemaEApiDataReader_impl ();
    
        virtual ~SemaEApiDataReader_impl ();
    ...
    private:
        SemaEApiDataReader_impl (const SemaEApiDataReader &);
        void operator= (const SemaEApiDataReader &);
    ...
    class OS_SEMADDS_API SemaEApiDataReaderView_impl : public virtual SemaEApiDataReaderView,
                                                               public ::DDS::OpenSplice::FooDataReaderView_impl
    {
        friend class DDS::OpenSplice::DataReader;
        friend class SemaEApiTypeSupportMetaHolder;
    ...
    protected:
        SemaEApiDataReaderView_impl ();
    
        virtual ~SemaEApiDataReaderView_impl ();
    ...
    private:
        SemaEApiDataReaderView_impl (const SemaEApiDataReaderView &);
    
        void operator= (const SemaEApiDataReaderView &);
    };
